  ...
  console.log($.getCities("Batangas")); 
          ...
          <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Add Call Center Agent</h4>
            </div>
            <a href="callcenter_departement.php?action=add" type="button" class="btn btn-primary bg-gradient-primary">Back</a>
            <div class="card-body">
              <div class="table-responsive">
                        <form role="form" method="post" action="callcenter_departement.php?action=add">
                        
                            <div class="form-group">
                              <select class="form-control" id="callcenteragent" placeholder="Call Center Agent" name="callcenteragent" required></select>
                            </div>
                            <div class="form-group">
                              <select class="form-control" id="callcenterdepartment" placeholder="Call Center Department" name="callcenter_dep" required></select>
                            </div>
