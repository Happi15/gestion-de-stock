            ...
            <div class="card-body">
              <div class="table-responsive">
                        <form role="form" method="post" action="callcenter_departement.php?action=add">
                            ...
                            <div class="form-group">
                              <input class="form-control" placeholder="Departement" name="Name" required>
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Number orders" name="numberorders" required>
                            </div>
                            <div class="form-group">
                              <?php
                                echo $opt;
