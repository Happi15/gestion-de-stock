...
<fieldset>
  <legend> <h6> Veuillez choisir le type de commande </h6></legend>
            <div class="form-group row mb-2">
...
<div>
          ...
          <label for="livraison"><input type="radio" name="typeCom" value="Livraison"  checked> Livraison</label>
          <br> 
          <label for="expedition"> <input type="radio" name="typeCom" value ="Expedition" > Expedition</label>
                  ...
                  <div class="form-group row text-left mb-2">
                    ...
                    <div class="col-sm-12 text-center">
                      ...
                      <h3 class="font-weight-bold py-3 bg-light">
                        Cfa <?php echo number_format($total, 2); ?>
                      </h3>
                    </div>
